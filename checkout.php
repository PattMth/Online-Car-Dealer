...
$total = 0;
$rentalDays = $_REQUEST["RentalDay"];
$index = 0;
foreach ($_SESSION["cart"] as $value) {
  $value["RentalDay"] = $rentalDays[$index];
...
***********************************************/
  ...
  function refresh(){
    location.href = "carReservation.php"
  }
...
<div class="body">
	<span class="close" onclick="refresh();" style="float:right">&#10006;</span>
	...
	<table width="90%" border="0">
		<tr>
			<td>First name <span style="color:#F00">* </span></td>
    			<td><input type="text" name="firstname" id="fname" size="50" /></td>
		</tr>
		<tr>
			<td>Last name <span style="color:#F00">* </span></td>
    			<td><input type="text" name="lastname" id="lname" size="50" /></td>
		</tr>
		<tr>
...
<option value="Zimbabwe">Zimbabwe</option>
		...
		<tr>
			<td>Post code <span style="color:#F00">* </span></td>
    			<td><input type="text" name="postcode" id="pcode" size="50" /></td>
		</tr>
		<tr>
...
<center>
  <h1>Total Price:  $<?php echo $total;?></h1>
      ...
      padding: 15px;" type="submit" value="Purchase"/>
</center>
	</form>
</div>
</body>
